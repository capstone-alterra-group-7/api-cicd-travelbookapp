...
public class OrderHotelPage {
    ...
    public String ValidEndpointUOH = "https://api.tripease.my.id/api/v1/user/hotel/order";
    public String InvalidEndpointUOH = "https://api.tripease.my.id/api/v1/user/hotel/orderXX";


    @Step("")
    public String setEndpointLoginUOH() {
        return endpointLogin;
    }

    @Step("")
    public void sendRequestLoginUOH() {
        ...
        SerenityRest.given().header("Authorization", "Bearer " + token).contentType("application/json").body(reqBody.toString()).post(setEndpointLoginUOH());
        token = lastResponse().getBody().jsonPath().get("data.token");
    }

    @Step("")
    public String setValidEndpointUOH() {
        return ValidEndpointUOH;
    }

    @Step("")
    public void sendRequestCreateUOH() {
        ...
        SerenityRest.given()
                ...
                .body(body)
                .post(setValidEndpointUOH());
    }


    @Step("")
    public void validateResponse201UOH() {
        restAssuredThat(response -> response.statusCode(201));
    }

    @Step("")
    public void validateValidDataResponseForUOH() {
    ...
    //==============================================================================INVALID ENDPOINT==============================
    @Step("")
    public String setEndpointUOH2() {
        return InvalidEndpointUOH;
    }
    @Step("")
    public void sendRequestCreateUOH2() {
        JSONObject requestBody = new JSONObject();
        requestBody.put("date_end", "2023-05-02");
        requestBody.put("date_start", "2023-05-01");
        requestBody.put("email_order", "me@hanifz.com");
        ...
        SerenityRest.given()
                ...
                .contentType("application/json")
                .body(body)
                .post(setEndpointUOH2());
    }


    @Step("")
    public void validateResponseUOH2() {
        restAssuredThat(response -> response.statusCode(404));
    }

    @Step("")
    public void validateResponseForUOH2() {
    ...
    //==============================================================================INVALID REQUEST==============================
    @Step("")
    public String setEndpointUOH3() {
        return ValidEndpointUOH;
    }
    @Step("")
    public void sendRequestCreateUOH3() {
        JSONObject requestBody = new JSONObject();
        requestBody.put("date_end", "2023-05-02");
        requestBody.put("date_start", "2023-05-01");
        requestBody.put("email_order", "me@hanifz.com");
    ...
    @Step("")
    public void validateResponseUOH3() {
        restAssuredThat(response -> response.statusCode(400));
    }

    @Step("")
    public void validateResponseForUOH3() {
